...
# Преимущества программы — шесть пунктов.
# Формулировка про аттестат намеренно уточняет, кто его выдаёт: центр
# не имеет права выдавать документы об образовании.
PROGRAM_BENEFITS = [
    "Программа ФГОС, аттестат выдаёт аккредитованная школа-партнёр",
    "Профориентация и совместный выбор вуза",
    "Гибкая система освоения программы",
    "Подготовка к экзаменам — академическая и психологическая",
    "Сбор портфолио: участие в конкурсах и олимпиадах",
    "Дополнительные программы для всестороннего развития",
]

# Пример учебного дня — из материалов центра.
SCHEDULE_MAIN = [
    ("9:00 – 9:20", "планирование"),
    ("9:30 – 10:10", "алгебра"),
    ("10:20 – 11:00", "алгебра (ОГЭ)"),
    ("11:00 – 11:20", "бранч"),
    ("11:20 – 12:00", "география"),
    ("12:10 – 12:50", "биология"),
    ("13:00 – 13:40", "история"),
    ("13:40 – 14:10", "обед"),
]
SCHEDULE_EXTRA = [
    ("14:10 – 14:50", "профориентация"),
    ("14:50 – 16:00", "самоподготовка с наставником"),
]

# Что оплачивается сверх тарифов.
EXTRA_COSTS = ["Питание", "Выездные мероприятия", "Профильные репетиторы"]
