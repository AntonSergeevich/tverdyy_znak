...
TEACHERS = [
    {
        ...
        "is_featured": True,
        # Наставник ведёт не предмет, а блоки дня. В расписании они нужны
        # так же, как алгебра: у утреннего круга тоже есть ведущий.
        # На карточке сайта это не видно — там своя подпись, subject_line.
        "subjects": [
            "Утренний круг",
            "Рефлексия",
